    ...
    <ul class="sidebar-menu">
      ...
      <li class="active treeview">
        ...
        <ul class="treeview-menu">
          ...
          <li class="active"><a href="#"><i class="fa fa-image"></i> Galeri</a></li>
            ...
            <div class="col-md-12">
              <div class="box-header">
                <div class="box-body pad">
                  <textarea id="caption" type="text"  required name="caption" rows="10" cols="80" class="textarea" placeholder="Tulis deskripsi sekolah" style="width: 100%; height: 250px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
                </div>
              </div>
            </div>
          </div>
    ...
    $(document).on('click', '.update', function(){
      ...
      $.ajax({
        ...
        success:function(data)
        {
          ...
          $('.modal-title').text("Edit foto Galeri");
          $('#id_foto').val(id_foto);
