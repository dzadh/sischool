    ...
    <ul class="sidebar-menu">
      ...
      <li class="active treeview">
        ...
        <ul class="treeview-menu">
          ...
          <li class="active"><a href="#"><i class="fa fa-users"></i>Guru</a></li>
...
<div class="content-wrapper">
  ...
  <ol class="breadcrumb">
    ...
    <li class="active">Kelola Favorit - Guru</li>
  </ol>
</section>
<!-- Main content -->
    ...
    <div class="col-xs-12">
      <div class="box">
        <div class="box-header">
          <button type="button" id="add_button" data-toggle="modal" data-target="#userModal" class="btn btn-primary "><i class="fa fa-plus"></i>Tambah Guru</button>
        </div>
      </br>
      <div class="box-body">
        ...
        <div class="modal-body">
          <table class="table table-hover">
            ...
            <tr>
              ...
              <td>
                <input type="text" name="jabatan_guru" id="jabatan_guru" class="form-control " required/>
              </td>
            </tr>
            <tr>
              <td>
              ...
              <td>
                <input type="text" name="mapel_guru" id="mapel_guru" class="form-control " required/>
              </td>
            </tr>
            <tr>
              <td>
              ...
              <td>
                <input type="text" name="email_guru" id="mapel_guru" class="form-control " required/>
              </td>
            </tr>
       		 <tr>
              <td>
...
<script type="text/javascript" language="javascript" >
  $(document).ready(function(){
    $('#add_button').click(function(){
      $('#user_form')[0].reset();
      $('.modal-title').text("Form Tambah Guru Sekolah");
      $('#action').val("Add");
      $('#operation').val("Add");
    ...
    $(document).on('click', '.update', function(){
      ...
      $.ajax({
        ...
        success:function(data)
        {
          ...
          $('#jabatan_guru').val(data.jabatan_guru);
