 	...
 	<body class="skin-blue-light fixed sidebar-mini ">
 		<div class="wrapper">
 			...
 			<header class="main-header">
 				<a href="halaman_admin.php" class="logo">
 ...
 <div class="content-wrapper">
 	...
 	<ol class="breadcrumb">
 		...
 		<li class="active">Kelola Sekolah</li>
 	</ol>
 </section>
 		...
 		<div class="col-xs-12">
 			<div class="box">
 				<div class="box-header">
 					<button type="button" id="add_button" data-toggle="modal" data-target="#userModal" class="btn btn-primary "><i class="fa fa-plus"></i>Tambah Sekolah</button>
 				</div>
 			</br>
 			<div class="box-body">
		...
		$(document).on('click', '.update', function(){
			...
			$.ajax({
				...
				success:function(data)
				{
					...
					$('#sekolah_telepon').val(data.sekolah_telepon);
					$('#sekolah_email').val(data.sekolah_email);
					$('#sekolah_web').val(data.sekolah_web);
