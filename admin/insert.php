...
if(isset($_POST["operation"]))
{
	if($_POST["operation"] == "Add")
	{
		...
		$statement = $connection->prepare("
			INSERT INTO sekolah (sekolah_nama, sekolah_deskripsi,sekolah_region,sekolah_jenjang, sekolah_alamat,sekolah_telepon,sekolah_email,sekolah_web, image) 
			VALUES (:sekolah_nama, :sekolah_deskripsi, :sekolah_region,:sekolah_jenjang,:sekolah_alamat,:sekolah_telepon,:sekolah_email,:sekolah_web, :image)
		");
